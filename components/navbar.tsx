...
export default function NavBar() {
    return (
        <div>
            <nav className="upperNav flex flex-row justify-between items-center bg-black w-full h-14 fixed">
                <div className="firstSec flex flex-row justify-center items-center gap-2 ml-5 cursor-pointer">
                    ...
                    <Link href={""}><ImYoutube2 className="text-red-500 text-7xl h-7" /></Link>
                </div>
                <div className="secSec flex flex-row justify-between items-center w-150">
                    <div className="searchInput flex flex-row justify-between items-center border-collapse cursor-pointer">
                        <input type="text" className="text-white w-128 h-8 rounded-l-2xl border border-white bg-black outline-none px-5" placeholder="Youtube Search..."/>
                        <FaSearch className="text-white p-1 rounded-r-2xl border border-white h-8 w-8" />
                    </div>
                    <div className="voiceSearch cursor-pointer">
                        <MdKeyboardVoice className="size-9 text-white p-1 ml-5 rounded-2xl border border-white" />
                    </div>
                </div>
